<script>
    ...
    function update_record(event){
        ...
        fetch('http://13.125.59.124:8000/modify_record', { // local 실행시 127.0.0.1으로 변환
            method: 'POST',
            headers: {
...
<div class='container'>
    ...
    <form method="post" class='my-3'>
        ...
        <div class="mb-3">
            <label for="subject">변경 요소</label>
            <input type="text" class="form-control" bind:value="{col}">
        </div><br>
        <div class="mb-3">
            <label for="subject">변경 값</label>
